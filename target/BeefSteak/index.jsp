...
<div class="clearfix nav">
    ...
    <ul class="clearfix nav-wrap">
        <li><a class="nav-item nav-active" href="html/index.html">首页</a></li>
        <li><a class="nav-item" href="html/pinpai.html">品牌故事</a></li>
        <li><a class="nav-item" href="html/meishi.html">美食系列</a></li>
        <li><a class="nav-item" href="html/shop.html">店面展示</a></li>
        <li><a class="nav-item" href="html/news.html">新闻资讯</a></li>
        <li><a class="nav-item" href="html/about-us.html">关于我们</a></li>
    </ul>
</div>
    ...
    <div class="newfood-box clearfix" id="newfood-table">
        <ul class="newfood-wrap clearfix newfood-show">
            <li class="newfood-item newfood-right newfood-li1">
                <a href="html/meishi-con.html" class="newfood-p1">茶漱海鲜汤</a>
            </li>
            <li class="newfood-item newfood-right newfood-li2">
                <a href="html/meishi-con.html" class="newfood-p2">玉米海螺沟</a>
            </li>
            <li class="newfood-item newfood-right newfood-li3">
                <a href="html/meishi-con.html" class="newfood-p3">芝士蛋糕卷</a>
            </li>
            <li class="newfood-item newfood-li4">
                <a href="html/meishi-con.html" class="newfood-p4">芝士大虾</a>
            </li>
            <li class="newfood-item newfood-right newfood-li5">
                <a href="html/meishi-con.html" class="newfood-p5">西冷牛排</a>
            </li>
            <li class="newfood-item newfood-right newfood-li6">
                <a href="html/meishi-con.html" class="newfood-p6">草莓布丁杯</a>
            </li>
            <li class="newfood-item newfood-right newfood-li7">
                <a href="html/meishi-con.html" class="newfood-p7">黑椒牛排</a>
            </li>
            <li class="newfood-item newfood-li8">
                <a href="html/meishi-con.html" class="newfood-p8">茶漱海鲜汤</a>
            </li>
        </ul>
...
<div class="news-wrap">
    ...
    <dl class="clearfix news-dl">
        ...
        <dd class="news-dd">
            <a href="html/news-con.html" class="news-link clearfix">
